...
class generate:
	...
	def __init__ (self,path='/Lustre01/tangqianzi/forJinOrth/expresion_level_coreAtlas/'):
		...
		self.path = path
		self.jobfolder = 'allcorrest2jobs'
...
Rscript '''+self.path+'/Rscripts/spearman2_'+mytissue+'.R'
	        ...
	        print>>myoutput1,'/usr/bin/perl /Lustre01/tangqianzi/software/scripts/qsub-sgenew.pl --maxjob 100 --lines 2 --jobprefix mydump --convert no --resource nodes=1:ppn=1,mem=900g '+self.path+'/'+self.jobfolder+'/alljobs_dump.sh'
